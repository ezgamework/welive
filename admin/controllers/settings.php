...
class c_settings extends Admin{
    ...
    public function index(){
		...
		TableRow(array('<B>上传文件功能</B><BR><font class=grey>是否允许访客上传文件? 访客上传功能包括上传图片和上传文件, 禁用上传文件功能不影响上传图片.<br>如果访客上传设置为不需要授权, 那么最好禁用上传文件功能, 以免不良用户随意上传病毒文件到服务器.</font>', $Radio->Get()));
